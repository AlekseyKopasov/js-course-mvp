...
Эта функция использует цикл для вычисления факториала числа. Факториал числа n - это произведение всех положительных целых чисел от 1 до n. `;export{n as default};
//# sourceMappingURL=01-introduction-DPlMZBd0.js.map
